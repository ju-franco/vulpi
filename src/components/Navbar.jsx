      ...
      if (user) {
        ...
        if (docSnap.exists()) {
          ...
          const novoUsuario = {
            ...
            email: user.email,
            foto: user.photoURL || "https://tse4.mm.bing.net/th/id/OIP.ZT7M33hqdCe92O_2UDtn1wHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
          };
  ...
  return (
    <> {/* <--- O Fragmento resolve o erro de retorno múltiplo */}
      ...
      <div style={styles.sidebar}>
        <div style={styles.logoSidebar}>VULPI</div>

        <div style={styles.navLinksContainer}>
          <div 
            style={getMenuItemStyle("/catalogo")} 
            onClick={() => navigate("/catalogo")}
            onMouseEnter={(e) => !isActive("/catalogo") && (e.currentTarget.style.backgroundColor = styles.menuItemHover.backgroundColor)}
            onMouseLeave={(e) => !isActive("/catalogo") && (e.currentTarget.style.backgroundColor = "transparent")}
          >
          ...
          <div 
            ...
            onMouseEnter={(e) => !isActive("/cadastro-item") && (e.currentTarget.style.backgroundColor = styles.menuItemHover.backgroundColor)}
            onMouseLeave={(e) => !isActive("/cadastro-item") && (e.currentTarget.style.backgroundColor = "transparent")}
          >
          ...
          <div 
            ...
            onMouseEnter={(e) => !isActive("/forum") && (e.currentTarget.style.backgroundColor = styles.menuItemHover.backgroundColor)}
            onMouseLeave={(e) => !isActive("/forum") && (e.currentTarget.style.backgroundColor = "transparent")}
          >
      ...
      <div style={styles.topbarNova}>
        <div style={styles.notificacoesContainer} onClick={() => alert("Mural em breve!")}>
          <IoNotificationsOutline />
          <span style={styles.badge}>!</span>
        </div>

        <div style={styles.perfilContainer} onClick={() => setAbaPerfil(!abaPerfil)}>
          <div style={{ textAlign: "right", marginRight: "10px" }}>
            <div style={{ fontSize: "14px", fontWeight: "600", color: "#333" }}>{usuario.nome}</div>
            <div style={{ fontSize: "11px", color: "#999" }}>{usuario.email}</div>
          </div>
          <img src={usuario.foto} alt="Perfil" style={styles.perfilFoto} />

          {abaPerfil && (
            <div style={styles.dropdownFlutuante} onClick={(e) => e.stopPropagation()}>
